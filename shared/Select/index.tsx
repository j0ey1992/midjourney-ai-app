      ...
      {({ open }) => (
        <div className={className}>
          ...
          <div className="relative mt-2">
            <Listbox.Button className="relative w-full cursor-default rounded-md border-neutral-200 bg-white py-1.5 pl-3 pr-10 text-left text-sm font-normal shadow-sm ring-1 ring-inset ring-gray-300 focus:border-primary-300 focus:outline-none focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:bg-neutral-200 dark:bg-neutral-900 dark:focus:ring-primary-600 dark:focus:ring-opacity-25 dark:disabled:bg-neutral-800 sm:text-sm sm:leading-6">
